...
theta1_space = np.linspace(theta1-3,theta1+3,9)
theta2_space = np.linspace(theta2-3,theta2+3,9)
theta1_grid,theta2_grid = np.meshgrid(theta1_space,theta2_space)
high_grid = loss_function(X,theta1_grid,theta2_grid,y)
print(high_grid)
plt.subplot(2,2,3)
plt.contourf(theta1_grid,theta2_grid,high_grid,10,alpha=0.6,cmap=plt.cm.hot)
